...
},{"./config/app":1,"./config/routes":2,"./controllers/application_controller":4,"./controllers/auth/login_controller":5,"./controllers/index_controller":6,"./routes/application_route":8,"./routes/auth/login_route":9,"./routes/error_route":10,"./routes/map_route":11,"./templates":12,"./views/application_view":13,"./views/index_view":14}],8:[function(require,module,exports){
...
},{"../config/session_manager":3}],9:[function(require,module,exports){
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  options = {hash:{},contexts:[depth0],types:["STRING"],hashContexts:hashContexts,hashTypes:hashTypes,data:data};
  data.buffer.push(escapeExpression(((stack1 = helpers.render || depth0.render),stack1 ? stack1.call(depth0, "menu", options) : helperMissing.call(depth0, "render", "menu", options))));
  data.buffer.push("\n\n<!-- Auth content -->\n<div class='login-container'>\n	<div class='auth-header'>Sign In</div>\n	<div class='auth-desc'>Got an Account? Awesome!</div>\n	<form id='login-form' ");
