...
},{"./config/app":1,"./config/routes":2,"./controllers/application_controller":4,"./controllers/auth/login_controller":5,"./controllers/auth/register_controller":6,"./controllers/index_controller":7,"./controllers/menu_controller":8,"./controllers/sidebar/trips/create_controller":9,"./controllers/sidebar/trips_controller":10,"./controllers/sidebar_controller":11,"./controllers/topbar_controller":12,"./helpers/tripHelper":13,"./models/profile":15,"./models/trip":16,"./routes/application_route":17,"./routes/auth/login_route":18,"./routes/auth/register_route":19,"./routes/error_route":20,"./routes/map_route":21,"./routes/sidebar/trips_route":22,"./templates":23,"./views/application_view":24,"./views/footer_view":25,"./views/index_view":26,"./views/map_view":27,"./views/sidebar/trips/create_view":28,"./views/sidebar_view":29,"./views/topbar_view":30}],15:[function(require,module,exports){
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "cancelCreate", {hash:{},contexts:[depth0],types:["STRING"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
